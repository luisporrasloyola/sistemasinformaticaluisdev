...
require_module_access('empresa.calidad');

$empresas = db()->query('SELECT id, razon_social, ruc FROM empresas WHERE status = 1 ORDER BY razon_social')->fetchAll();
$catalogo = filter_allowed_documents('empresa.calidad', db()->query('SELECT id, nombre FROM empresa_calidad_catalogo WHERE estado = 1 ORDER BY id')->fetchAll(), 'id', 'upload');
require __DIR__ . '/../../includes/header.php';
?>
<div class="page-title">
    <div>
        <h1>Calidad de empresa</h1>
        <p>Control documentario de calidad por empresa.</p>
    </div>
</div>

<div class="company-generic-module" data-company-module="calidad" data-module-title="Calidad">
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <form class="modal-content needs-validation js-company-generic-form" novalidate>
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="module" value="calidad">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <?php if (current_user_can_manage_scope('empresa.calidad')): ?>
