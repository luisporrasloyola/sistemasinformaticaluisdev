...
$catalogo = filter_allowed_documents('empresa.seguridad', db()->query('SELECT id, nombre FROM empresa_seguridad_catalogo WHERE estado = 1 ORDER BY id')->fetchAll(), 'id', 'upload');
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <?php if (current_user_can_manage_scope('empresa.seguridad')): ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <input class="form-control" type="file" name="pdf" id="companySecurityPdfInput" accept="application/pdf,image/jpeg,image/png,image/webp">
