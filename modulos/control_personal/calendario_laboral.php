...
function calendar_badge_class(string $eventType): string
{
    return match ($eventType) {
        'holiday' => 'text-bg-danger',
        'non_working' => 'text-bg-secondary',
...
<div class="page-title">
    <div>
        ...
        <p>Feriados, d&iacute;as no laborables y vacaciones del personal.</p>
    </div>
...
<div class="work-panel">
    <div class="calendar-legend mb-3">
        <span><i class="calendar-dot calendar-dot-holiday"></i>Feriado</span>
        <span><i class="calendar-dot calendar-dot-off"></i>No laborable</span>
        <span><i class="calendar-dot calendar-dot-vacation"></i>Vacaciones</span>
    </div>
        ...
        <table class="table table-hover align-middle" id="calendarDaysTable">
            ...
            <?php foreach ($calendarDays as $event): ?>
                ...
                <tr>
                    ...
                    <td><span class="badge <?= calendar_badge_class($eventType) ?>"><?= e(attendance_calendar_event_label($eventType)) ?></span></td>
                    <td><?= e($event['name']) ?></td>
