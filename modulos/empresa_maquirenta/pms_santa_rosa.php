...
window.pmsMaquirentaConfig = {
    serviceUrl: <?= json_encode(APP_URL . '/servicios/empresa_maquirenta/pms_santa_rosa.php') ?>,
    csrfToken: <?= json_encode(csrf_token()) ?>
};
</script>
<script src="<?= APP_URL ?>/recursos/js/empresa_maquirenta_pms_santa_rosa.js?v=<?= filemtime(__DIR__ . '/../../recursos/js/empresa_maquirenta_pms_santa_rosa.js') ?>"></script>
