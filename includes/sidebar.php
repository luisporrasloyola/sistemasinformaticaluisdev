        ...
        <div class="collapse <?= $controlPersonalOpen ? 'show' : '' ?>" id="controlPersonalMenu">
            <div class="submenu">
                <?php if ($isAdmin): ?>
                    ...
                    <a class="nav-link sub-link js-development-link" href="<?= APP_URL ?>/modulos/aliados/personal.php"><i class="fa-solid fa-users"></i><span>Personal</span></a>
        ...
        <?php if (is_gestor_role()): ?>
            ...
            <?php if (current_user_can_module('control_personal')): ?>
                ...
                <div class="collapse <?= $controlPersonalOpen ? 'show' : '' ?>" id="controlPersonalMenuGestor"><div class="submenu">
                    ...
                    <?php if (current_user_can_module('control_personal.personal')): ?><a class="nav-link sub-link js-development-link" href="<?= APP_URL ?>/modulos/aliados/personal.php"><i class="fa-solid fa-users"></i><span>Personal</span></a><?php endif; ?>
