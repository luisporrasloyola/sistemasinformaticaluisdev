...
$empresaMaquirentaDashboardOpen = str_ends_with($currentPath, '/modulos/empresa_maquirenta/dashboard.php');
    ...
    <nav class="nav flex-column sidebar-menu">
        ...
        <?php if ($isAdmin): ?>
            ...
            <div class="collapse <?= $empresaMaquirentaOpen ? 'show' : '' ?>" id="empresaMaquirentaMenu">
                <div class="submenu">
                    <a class="nav-link sub-link <?= $empresaMaquirentaDashboardOpen ? 'active' : '' ?>" href="<?= APP_URL ?>/modulos/empresa_maquirenta/dashboard.php"><i class="fa-solid fa-chart-pie"></i><span>Dashboard</span></a>
        ...
        <?php if (is_gestor_role()): ?>
            ...
            <?php if (current_user_can_module('empresa_maquirenta')): ?>
                ...
                <div class="collapse <?= $empresaMaquirentaOpen ? 'show' : '' ?>" id="empresaMaquirentaMenuGestor"><div class="submenu">
                    <?php if (current_user_can_module('empresa_maquirenta.dashboard')): ?><a class="nav-link sub-link <?= $empresaMaquirentaDashboardOpen ? 'active' : '' ?>" href="<?= APP_URL ?>/modulos/empresa_maquirenta/dashboard.php"><i class="fa-solid fa-chart-pie"></i><span>Dashboard</span></a><?php endif; ?>
