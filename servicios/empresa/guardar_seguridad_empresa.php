...
try {
    ...
    if ($id > 0) {
        ...
        $stmt = db()->prepare('INSERT INTO empresa_seguridad_documentos (empresa_id, documento_id, fecha_registro, fecha_inicio, fecha_fin, observaciones, archivo_path, archivo_nombre_original)
