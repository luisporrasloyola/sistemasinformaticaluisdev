...
if (!is_admin() && !current_user_can_document('empresa_maquirenta.pmi_individual', $requirementCatalogId, 'upload')) {
...
try {
    ...
    $historyStmt = $pdo->prepare("SELECT COUNT(*) FROM empresa_maquirenta_formato_requisito_actividad
    ...
    $insertHistory = $pdo->prepare('INSERT INTO empresa_maquirenta_formato_requisito_actividad
    ...
    $stmt = $pdo->prepare("UPDATE empresa_maquirenta_formato_requisitos
