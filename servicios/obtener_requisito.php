...
require_personal_own_worker((int) $row['worker_id'], false);
if (!current_user_can_document('requisitos.pmi_individual', (int) $row['requirement_id'], 'view')) json_response(['ok' => false, 'message' => 'No tiene permiso para visualizar este requisito.'], 403);
